...
def recursive_to_device(
    ...
    if hasattr(data, "to"):
        ...
        # Handle tuple explicitly to preserve tuple type
        return tuple(recursive_to_device(d, device, non_blocking) for d in data)
    elif isinstance(data, list):
        # Handle list explicitly
        return [recursive_to_device(d, device, non_blocking) for d in data]
